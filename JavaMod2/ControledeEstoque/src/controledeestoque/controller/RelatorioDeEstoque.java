...
table.addCell(celldescricao);
 ...
 public boolean geraRelatorio() throws Exception{
     ...
     try{
         ...
         document.add(new Paragraph(" "));
         t = new Paragraph("RELATÓRIO DE ESTOQUE!", new Font(Font.FontFamily.UNDEFINED, 16, Font.BOLD));
         t.setAlignment(Element.ALIGN_CENTER);
         document.add(t);
         document.add(new Paragraph("_____________________________________" + "____________________"));
